...
-   [OptimalBits/bull](https://github.com/OptimalBits/bull) : [Message Queue (MQ)]({{< relref "20230404153903-message_passing.md#message-queue--mq" >}}) for nodeJS
...
-   [ ] Is the data being rendered via canvas, so no [DOM]({{< relref "20230614133347-dom.md" >}}) at all? Maybe tools [shot-scraper](https://shot-scraper.datasette.io), [ishan0102/vimGPT](https://github.com/ishan0102/vimGPT), [OpenAdapt](https://github.com/OpenAdaptAI/OpenAdapt) can help?
