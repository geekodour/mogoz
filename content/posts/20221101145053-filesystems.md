...
-   [Common Terms](#common-terms)
    -   [inodes](#inodes)
    -   [file desc vs inodes](#file-desc-vs-inodes)
    -   [Types](#types)
-   [VFS](#vfs)
    -   [Booting](#booting)
    -   [Syscall mechanism](#syscall-mechanism)
-   [Container Filesystem](#container-filesystem)
-   [Binding, Mounting, Volumes](#binding-mounting-volumes)
    -   [Binding](#binding)
    -   [Mount related files](#mount-related-files)
    -   [Pseudo Filesystems](#pseudo-filesystems)
    -   [procfs](#procfs)
    -   [sysfs](#sysfs)
    -   [`configfs` vs `sysfs`](#configfs-vs-sysfs)
    -   [tempfs](#tempfs)
