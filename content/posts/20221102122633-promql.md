...
| Operations  | Operands                   |
|-------------|----------------------------|
| Aggregation | Instant vectors            |
| Binary      | Scalar&amp;Instant Vectors |
...
### Instant vs Range vectors {#instant-vs-range-vectors}
...
### Request and Response combinations {#request-and-response-combinations}
