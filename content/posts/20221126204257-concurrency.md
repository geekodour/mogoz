...
> I HAVE ISSUES w this section and few other sections.
...
> This is not a strict list, just trying to categorize shit i see in the wild.
</div>
...
See [Flynn's Taxonomy]({{< relref "20221101202303-multiprocessing.md#flynn-s-taxonomy" >}})
...
-  Floating Point
    ...
    -   Full precision: Either FP32 or FP24 or greater,
    -   Partial precision: FP16
...
Language syntax based. `channels` and `groutines` in [Golang]({{< relref "20221101220915-golang.md" >}}).
...
## Concurrency FAQ {#concurrency-faq}


### Where do we apply this? {#where-do-we-apply-this}
...
### How do processes communicate w each other? {#how-do-processes-communicate-w-each-other}
