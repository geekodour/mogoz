...
-   [maxpert/marmot](https://github.com/maxpert/marmot) : Multi-writer distributed SQLite based on NATS (See [Message Queue (MQ)]({{< relref "20230404153903-message_passing.md#message-queue--mq" >}}))
